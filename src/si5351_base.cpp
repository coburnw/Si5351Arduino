...
bool Si5351::init(uint8_t xtal_load_c, uint32_t xo_freq, int32_t corr)
{
	...
	if(reg_val == 0)
	{
		...
		this->si5351_write(SI5351_CRYSTAL_LOAD, (xtal_load_c & SI5351_CRYSTAL_LOAD_MASK) | 0b00010010);
...
void Si5351::reset(void)
{
	...
	// First, turn them off
	this->si5351_write(16, 0x80);
	this->si5351_write(17, 0x80);
	this->si5351_write(18, 0x80);
	this->si5351_write(19, 0x80);
	this->si5351_write(20, 0x80);
	this->si5351_write(21, 0x80);
	this->si5351_write(22, 0x80);
	this->si5351_write(23, 0x80);

	// Turn the clocks back on...
	this->si5351_write(16, 0x0c);
	this->si5351_write(17, 0x0c);
	this->si5351_write(18, 0x0c);
	this->si5351_write(19, 0x0c);
	this->si5351_write(20, 0x0c);
	this->si5351_write(21, 0x0c);
	this->si5351_write(22, 0x0c);
	this->si5351_write(23, 0x0c);
	...
	this->si5351_write(SI5351_VXCO_PARAMETERS_LOW, 0);
	this->si5351_write(SI5351_VXCO_PARAMETERS_MID, 0);
	this->si5351_write(SI5351_VXCO_PARAMETERS_HIGH, 0);
...
void Si5351::set_pll(uint64_t pll_freq, enum si5351_pll target_pll)
{
  ...
  if(target_pll == SI5351_PLLA)
  {
    this->si5351_write_bulk(SI5351_PLLA_PARAMETERS, i, params);
		plla_freq = pll_freq;
  }
  else if(target_pll == SI5351_PLLB)
  {
    this->si5351_write_bulk(SI5351_PLLB_PARAMETERS, i, params);
		pllb_freq = pll_freq;
  }
...
void Si5351::set_ms(enum si5351_clock clk, struct Si5351RegSet ms_reg, uint8_t int_mode, uint8_t r_div, uint8_t div_by_4)
{
	...
	{
		case SI5351_CLK0:
			this->si5351_write_bulk(SI5351_CLK0_PARAMETERS, i, params);
			set_int(clk, int_mode);
			ms_div(clk, r_div, div_by_4);
			break;
		case SI5351_CLK1:
			this->si5351_write_bulk(SI5351_CLK1_PARAMETERS, i, params);
			set_int(clk, int_mode);
			ms_div(clk, r_div, div_by_4);
			break;
		case SI5351_CLK2:
			this->si5351_write_bulk(SI5351_CLK2_PARAMETERS, i, params);
			set_int(clk, int_mode);
			ms_div(clk, r_div, div_by_4);
			break;
		case SI5351_CLK3:
			this->si5351_write_bulk(SI5351_CLK3_PARAMETERS, i, params);
			set_int(clk, int_mode);
			ms_div(clk, r_div, div_by_4);
			break;
		case SI5351_CLK4:
			this->si5351_write_bulk(SI5351_CLK4_PARAMETERS, i, params);
			set_int(clk, int_mode);
			ms_div(clk, r_div, div_by_4);
			break;
		case SI5351_CLK5:
			this->si5351_write_bulk(SI5351_CLK5_PARAMETERS, i, params);
			set_int(clk, int_mode);
			ms_div(clk, r_div, div_by_4);
			break;
		case SI5351_CLK6:
			this->si5351_write(SI5351_CLK6_PARAMETERS, temp);
			ms_div(clk, r_div, div_by_4);
			break;
		case SI5351_CLK7:
			this->si5351_write(SI5351_CLK7_PARAMETERS, temp);
			ms_div(clk, r_div, div_by_4);
			break;
	}
...
void Si5351::output_enable(enum si5351_clock clk, uint8_t enable)
{
  ...
  this->si5351_write(SI5351_OUTPUT_ENABLE_CTRL, reg_val);
}
...
void Si5351::drive_strength(enum si5351_clock clk, enum si5351_drive drive)
{
  ...
  this->si5351_write(SI5351_CLK0_CTRL + (uint8_t)clk, reg_val);
}
...
void Si5351::set_phase(enum si5351_clock clk, uint8_t phase)
{
	...
	this->si5351_write(SI5351_CLK0_PHASE_OFFSET + (uint8_t)clk, phase);
}
...
void Si5351::pll_reset(enum si5351_pll target_pll)
{
	if(target_pll == SI5351_PLLA)
 	{
    	this->si5351_write(SI5351_PLL_RESET, SI5351_PLL_RESET_A);
	}
	else if(target_pll == SI5351_PLLB)
	{
	    this->si5351_write(SI5351_PLL_RESET, SI5351_PLL_RESET_B);
	}
}
...
void Si5351::set_clock_fanout(enum si5351_clock_fanout fanout, uint8_t enable)
{
	...
	this->si5351_write(SI5351_FANOUT_ENABLE, reg_val);
}
...
void Si5351::set_vcxo(uint64_t pll_freq, uint8_t ppm)
{
	...
	this->si5351_write(SI5351_VXCO_PARAMETERS_LOW, temp);

	temp = (uint8_t)((vcxo_param >> 8) & 0xFF);
	this->si5351_write(SI5351_VXCO_PARAMETERS_MID, temp);

	temp = (uint8_t)((vcxo_param >> 16) & 0x3F);
	this->si5351_write(SI5351_VXCO_PARAMETERS_HIGH, temp);
}
